...
class Camera:
    def __init__(self, position = (0,0, -10), target = (0, 0, 0), up=(0.0, 1.0, 0.0), fov=45, aspect=16/9, near=0.1, far=100):
    ...
    def get_sky_gradient(self, heigth):
        point = pow(0.5 *(heigth + 1.0), 1.5)
